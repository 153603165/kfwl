...
public class TransferResponse {
	...
	public String toString() {
		return "TransferResponse [return_code=" + return_code + ", return_msg="
				+ return_msg + ", mch_appid=" + mch_appid + ", mchid=" + mchid
				+ ", device_info=" + device_info + ", nonce_str=" + nonce_str
				+ ", result_code=" + result_code + ", err_code=" + err_code
				+ ", err_code_des=" + err_code_des + ", partner_trade_no="
				+ partner_trade_no + ", payment_no=" + payment_no
